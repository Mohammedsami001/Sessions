    ...
    <section ref={ref} className="relative min-h-[150vh] flex items-center justify-center border-b-[4px] border-[#333] bg-[#050505] overflow-hidden">
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col md:flex-row items-center justify-center p-8 gap-16 z-10">
        ...
        >
          ...
          <h2 className="text-6xl md:text-8xl font-playfair font-black italic uppercase tracking-tighter leading-none mb-4">
            The Data
          </h2>
        ...
        >
          {/* Leaderboard Mod */}
          <div className="border-4 border-[#333] bg-black p-6 relative hover:border-white transition-colors duration-300">
            <div className="absolute -top-3 right-4 px-2 font-mono font-bold text-black bg-white uppercase text-xs">
              LEADERBOARD_MOD
            </div>
          ...
          {/* Tasks Mod */}
          <div className="border-4 border-[#333] bg-[#E1E0CC] p-6 relative ml-12 text-black hover:bg-white transition-colors duration-300">
            <div className="absolute -top-3 left-4 px-2 font-mono font-bold text-white bg-black uppercase text-xs">
              TASKS_MOD
            </div>
