  ...
  return (
    <section ref={ref} className="relative min-h-[150vh] flex items-center justify-center border-b-[4px] border-[#333] bg-[#050505] overflow-hidden">
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col md:flex-row-reverse items-center justify-center p-8 gap-16 z-10">
        ...
        >
          {/* Chat Mod */}
          <div className="border-4 border-[#333] bg-black p-6 relative ml-12 z-20 hover:-translate-y-2 transition-transform duration-500 rounded-xl">
            <div className="absolute -top-3 left-6 px-3 font-mono font-bold text-black bg-white uppercase text-xs rounded-md">
              CHAT_MOD
            </div>
          ...
          {/* Rooms Mod */}
          <div className="border-4 border-[#333] bg-black p-6 relative mr-12 z-10 -mt-10 hover:-translate-y-2 transition-transform duration-500 rounded-xl">
            <div className="absolute -top-3 right-6 px-3 font-mono font-bold text-[#333] bg-[#E1E0CC] uppercase text-xs rounded-md">
              ROOMS_MOD
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="border border-white/20 p-4 flex flex-col gap-2 rounded-lg">
                <span className="font-mono text-xs text-zinc-400">GLOBAL_01</span>
                <span className="font-black text-xl">124 ON</span>
              </div>
              <div className="border border-white/20 p-4 flex flex-col gap-2 bg-white/5 rounded-lg">
