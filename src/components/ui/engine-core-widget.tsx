...
export default function EngineCoreWidget({ profile }: { profile: any }) {
  return (
    <div className="flex flex-col justify-center items-center text-center bg-white/5 border border-white/10 p-6 rounded-2xl relative group min-h-[460px] shadow-sm hover:border-white/20 transition-colors">
